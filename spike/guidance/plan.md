...
Maintain a revisable working notebook, not workflow evidence.
...
- Pause for operator or design review after a second remediation verdict, a reopened finding, or consecutive non-progress outcomes.

Revise the Plan whenever evidence changes the direction; never present tentative planner prose as authoritative scope or completion.
