...
- For lifecycle work, name execution-completion ownership separately from observation ownership; define observer-loss and supervisor-restart behavior. When lifecycle ownership or defaults change, require multiline stale-claim searches across CLI help, documentation, and source comments.
